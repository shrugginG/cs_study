...
private:
    ...
    */
    struct node {
        ...
        */
        node(const value_type& value = value_type(), std::shared_ptr<node> next = nullptr) :
    ...
    */
    using node_pair = std::pair<typename HashMap::std::shared_ptr<node>, typename HashMap::std::shared_ptr<node> >;
    ...
    * Hint: on the assignment, you should NOT need to call this function.
    */
    iterator make_iterator(std::shared_ptr<node> curr);
    ...
    */
    std::vector<std::shared_ptr<node> > _buckets_array;
